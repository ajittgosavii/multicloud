...
class AzureAiassistantModule:
    ...
    def render():
        ...
        with tabs[0]:
            AzureAiassistantModule._render_overview()
        with tabs[1]:
            AzureAiassistantModule._render_configuration()
        with tabs[2]:
            AzureAiassistantModule._render_operations()
        with tabs[3]:
            AzureAiassistantModule._render_analytics()
